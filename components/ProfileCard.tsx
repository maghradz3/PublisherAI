...
import { PublishmentProps, ProfileCardProps } from "@/types";
...
const ProfileCard = ({
  ...
  useEffect(() => {
    if (randomPublication) {
      setAudio({
        title: randomPublication.publishmentTitle,
        audioUrl: randomPublication.audioUrl || "",
        imageUrl: randomPublication.imageUrl || "",
        author: randomPublication.author,
        publicationId: randomPublication._id,
      });
    }
  }, [randomPublication, setAudio]);
